...
from backend.app.db.models.briefcase import BriefcaseModel, BriefcaseRegistryModel
from backend.app.services.briefcase_service import BriefcaseService
from backend.app.api.briefcase.scheme import (
    BriefcaseDTO,
    BriefcaseInputDTO,
...
async def create_briefcase_registry(
    briefcase_id: int,
    current_user: CurrentUser,
