...
from server.src.db.models.briefcase import CurrencyEnum, RegistryOperationEnum
...
async def test_create_briefcase_model(
    ...
    url = fastapi_app.url_path_for("create_briefcase")
    fill_up = 100.0
...
async def test_get_briefcase(
    ...
    url = fastapi_app.url_path_for("get_briefcase", briefcase_id=briefcase.id)
...
async def test_create_briefcase_registry_model(
    ...
    url = fastapi_app.url_path_for(
        "create_briefcase_registry", briefcase_id=briefcase.id
    )
